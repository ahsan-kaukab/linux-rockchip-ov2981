...
#define OV9281_PIXEL_RATE		(OV9281_LINK_FREQ_400MHZ * 2 * 2 / 8)
...
static const struct regval ov9281_1280x800_regs[] = {
    ...
    {0x3808, 0x05}, // ISP Horizontal Output Width High Byte (1280)
    {0x3809, 0x00}, // ISP Horizontal Output Width Low Byte
    {0x380a, 0x03}, // ISP Vertical Output Height High Byte (800)
    {0x380b, 0x20}, // ISP Vertical Output Height Low Byte

    {0x380c, 0x05}, // Total Horizontal Timing Size High Byte
    {0x380d, 0xb0}, // Total Horizontal Timing Size Low Byte
				  ...
				  struct rkmodule_inf *inf)
{
	...
	strlcpy(inf->base.module, ov9281->module_name, sizeof(inf->base.module));
